...
export default function ListaSupermercado() {
  ...
  useEffect(() => {
    const Supermercado = localStorage.getItem("Supermercado");
    if (Supermercado) {
      setItens(JSON.parse(Supermercado));
    }
  }, []);

  useEffect(() => {
    localStorage.setItem("Supermercado", JSON.stringify(itens));
  }, [itens]);
  ...
  function adicionarItem() {
    ...
    const novo = { nome: novoItem.trim(), comprado: false };
    setItens([...itens, novo]);
    setNovoItem("");
  }
